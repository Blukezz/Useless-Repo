...
for i, AAA in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
    if AAA:IsA("Accessory") and AAA.Name == "MeshPartAccessory" and AAA.Handle["SpecialMesh"].MeshId == "rbxassetid://11263221350" then
        ...
        AAA.Name = "ExenusRightLeg"
    elseif AAA:IsA("Accessory") and AAA.Name == "Unloaded head" and AAA.Handle["SpecialMesh"].MeshId == "rbxassetid://11159370334" then
        print("SUCCESS: Rectangle Head (White) / Detected!")
        AAA.Name = "ExenusLeftLeg"
    elseif AAA:IsA("Accessory") and AAA.Name == "Puffer Vest" and AAA.Handle["SpecialMesh"].MeshId == "rbxassetid://12483473635" then
        print("SUCCESS: Black Puffer Vest 1.0 [Closed] / Detected!")
        AAA.Name = "ExenusTorso"
    elseif AAA:IsA("Accessory") and AAA.Name == "Extra Right hand (Blocky)" and AAA.Handle["SpecialMesh"].MeshId == "rbxassetid://11449388499" then
        print("SUCCESS: Extra Right hand (moving / Blocky) [Closed] / Detected!")
        AAA.Name = "ExenusRightArm"
    elseif AAA:IsA("Accessory") and AAA.Name == "Extra Left hand (Blocky)" and AAA.Handle["SpecialMesh"].MeshId == "rbxassetid://11449386931" then
        print("SUCCESS: Extra Left hand (moving / Blocky) [Closed] / Detected!")
        AAA.Name = "ExenusLeftArm"
    end
end
...
local hat2 = gp(cplayer, "ExenusTorso", "Accessory")
...
local hat2 = gp(cplayer, "ExenusLeftArm", "Accessory")
local handle2 = gp(hat2, "Handle", "BasePart")
local att2 = gp(handle2, "att1_Handle", "Attachment")
att2.Parent = cplayer["Left Arm"]
att2.Position = Vector3.new(0, -0, 0)
att2.Rotation = Vector3.new(-115, 0, 0)

local hat2 = gp(cplayer, "ExenusRightArm", "Accessory")
local handle2 = gp(hat2, "Handle", "BasePart")
local att2 = gp(handle2, "att1_Handle", "Attachment")
att2.Parent = cplayer["Right Arm"]
att2.Position = Vector3.new(-0, -0, 0)
att2.Rotation = Vector3.new(-115, 0, 0) --LavanderHair

local hat2 = gp(cplayer, "ExenusLeftLeg", "Accessory")
local handle2 = gp(hat2, "Handle", "BasePart")
local att2 = gp(handle2, "att1_Handle", "Attachment")
...
local hat2 = gp(cplayer, "ExenusRightLeg", "Accessory")
local handle2 = gp(hat2, "Handle", "BasePart")
local att2 = gp(handle2, "att1_Handle", "Attachment")
