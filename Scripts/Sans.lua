...
print("> Running Undertale Sans by Nebula_Zorua")

-- You can change the Magic Circle n stuff down under Customization, at MagicVariant --

--// Quick music for funni effect added in by the one and only specowos 🧐
local fml = Instance.new("Sound")
fml.SoundId = "rbxassetid://4826067576"
fml.Looped = true
fml.Playing = true
fml.Parent = Game:GetService("Players").LocalPlayer.PlayerGui
fml.Volume = 2
